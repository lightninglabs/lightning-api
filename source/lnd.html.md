...
- [`watchtowerrpc/watchtower.proto`](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/watchtowerrpc/watchtower.proto)
...
### gRPC Request: [autopilotrpc.SetScoresRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/autopilotrpc/autopilot.proto#L68)
...
### gRPC Request: [chainrpc.SpendRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/chainrpc/chainnotifier.proto#L78)
...
### gRPC Request: [lnrpc.ChannelAcceptResponse (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1102)
...
### gRPC Request: [lnrpc.DisconnectPeerRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1285)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.FeeReportRequest()
...
### gRPC Request: [lnrpc.FeeReportRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3291)


This request has no parameters.

### gRPC Response: [lnrpc.FeeReportResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3311)


Parameter | Type | Description
--------- | ---- | ----------- 
channel_fees | [array ChannelFeeReport](#lnrpc-channelfeereport) | An array of channel fee reports which describes the current fee schedule / for each channel. 
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ForwardingHistoryRequest(
        start_time=<uint64>,
        end_time=<uint64>,
        index_offset=<uint32>,
...
### gRPC Request: [lnrpc.ForwardingHistoryRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3362)
...
### gRPC Response: [lnrpc.ForwardingHistoryResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3419)


Parameter | Type | Description
--------- | ---- | ----------- 
forwarding_events | [array ForwardingEvent](#lnrpc-forwardingevent) | A list of forwarding events from the time slice of the time series / specified in the request. 
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.FundingTransitionMsg(
...
### gRPC Request: [lnrpc.FundingTransitionMsg ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2021)


Parameter | Type | Description
--------- | ---- | ----------- 
shim_register | [FundingShim](#lnrpc-fundingshim) | The funding shim to register. This should be used before any channel funding has began by the remote party, as it is intended as a preparatory step for the full channel funding. 
shim_cancel | [FundingShimCancel](#lnrpc-fundingshimcancel) | Used to cancel an existing registered funding shim. 
psbt_verify | [FundingPsbtVerify](#lnrpc-fundingpsbtverify) | Used to continue a funding flow that was initiated to be executed through a PSBT. This step verifies that the PSBT contains the correct outputs to fund the channel. 
psbt_finalize | [FundingPsbtFinalize](#lnrpc-fundingpsbtfinalize) | Used to continue a funding flow that was initiated to be executed through a PSBT. This step finalizes the funded and signed PSBT, finishes negotiation with the peer and finally publishes the resulting funding transaction.  
### gRPC Response: [lnrpc.FundingStateStepResp ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2050)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ChanInfoRequest(
        chan_id=<uint64>,
    )
...
### gRPC Request: [lnrpc.ChanInfoRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2673)
...
### gRPC Response: [lnrpc.ChannelEdge ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2606)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.GetInfoRequest()
...
### gRPC Request: [lnrpc.GetInfoRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1657)


This request has no parameters.

### gRPC Response: [lnrpc.GetInfoResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1659)
...
chains | [array Chain](#lnrpc-chain) | A list of active chains the node is connected to 
uris | array string | The URIs of the current node. 
features | [array FeaturesEntry](#lnrpc-getinforesponse-featuresentry) | Features that our node has advertised in our init message, node announcements and invoices.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.NetworkInfoRequest()
...
### gRPC Request: [lnrpc.NetworkInfoRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2682)


This request has no parameters.

### gRPC Response: [lnrpc.NetworkInfo ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2684)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.NodeInfoRequest(
        pub_key=<string>,
...
### gRPC Request: [lnrpc.NodeInfoRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2542)
...
### gRPC Response: [lnrpc.NodeInfo ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2550)
...
channels | [array ChannelEdge](#lnrpc-channeledge) | A list of all public channels for the node.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.NodeMetricsRequest(
...
### gRPC Request: [lnrpc.NodeMetricsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2649)


Parameter | Type | Description
--------- | ---- | ----------- 
types | [array NodeMetricType](#lnrpc-nodemetrictype) | The requested node metrics.  
### gRPC Response: [lnrpc.NodeMetricsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2654)


Parameter | Type | Description
--------- | ---- | ----------- 
betweenness_centrality | [array BetweennessCentralityEntry](#lnrpc-nodemetricsresponse-betweennesscentralityentry) | Betweenness centrality is the sum of the ratio of shortest paths that pass through the node for each pair of nodes in the graph (not counting paths starting or ending at this node). Map of node pubkey to betweenness centrality of the node. Normalized values are in the [0,1] closed interval.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.GetTransactionsRequest()
...
### gRPC Request: [lnrpc.GetTransactionsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L899)


This request has no parameters.

### gRPC Response: [lnrpc.TransactionDetails ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L901)


Parameter | Type | Description
--------- | ---- | ----------- 
transactions | [array Transaction](#lnrpc-transaction) | The list of transactions relevant to the wallet.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ListChannelsRequest(
        active_only=<bool>,
        inactive_only=<bool>,
        public_only=<bool>,
        private_only=<bool>,
...
### gRPC Request: [lnrpc.ListChannelsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1469)
...
### gRPC Response: [lnrpc.ListChannelsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1481)


Parameter | Type | Description
--------- | ---- | ----------- 
channels | [array Channel](#lnrpc-channel) | The list of active channels  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ListInvoiceRequest(
        pending_only=<bool>,
        index_offset=<uint64>,
...
### gRPC Request: [lnrpc.ListInvoiceRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2999)
...
### gRPC Response: [lnrpc.ListInvoiceResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3021)


Parameter | Type | Description
--------- | ---- | ----------- 
invoices | [array Invoice](#lnrpc-invoice) | A list of invoices from the time slice of the time series specified in the request. 
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ListPaymentsRequest(
...
### gRPC Request: [lnrpc.ListPaymentsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3178)
...
### gRPC Response: [lnrpc.ListPaymentsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3207)


Parameter | Type | Description
--------- | ---- | ----------- 
payments | [array Payment](#lnrpc-payment) | The list of payments 
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ListPeersRequest(
        latest_error=<bool>,
    )
...
### gRPC Request: [lnrpc.ListPeersRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1629)
...
### gRPC Response: [lnrpc.ListPeersResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1637)


Parameter | Type | Description
--------- | ---- | ----------- 
peers | [array Peer](#lnrpc-peer) | The list of currently connected peers  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ListUnspentRequest(
        min_confs=<int32>,
        max_confs=<int32>,
    )
...
### gRPC Request: [lnrpc.ListUnspentRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1210)
...
### gRPC Response: [lnrpc.ListUnspentResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1217)


Parameter | Type | Description
--------- | ---- | ----------- 
utxos | [array Utxo](#lnrpc-utxo) | A list of utxos  
...
### gRPC Request: [lnrpc.PaymentHash ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2983)
...
### gRPC Response: [lnrpc.Invoice ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2782)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.NewAddressRequest(
        type=<AddressType>,
    )
...
### gRPC Request: [lnrpc.NewAddressRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1235)


Parameter | Type | Description
--------- | ---- | ----------- 
type | [AddressType](#lnrpc-addresstype) | The address type  
### gRPC Response: [lnrpc.NewAddressResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1239)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.OpenChannelRequest(
        node_pubkey=<bytes>,
...
### gRPC Request: [lnrpc.OpenChannelRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1811)
...
funding_shim | [FundingShim](#lnrpc-fundingshim) | Funding shims are an optional argument that allow the caller to intercept certain funding functionality. For example, a shim can be provided to use a particular key for the commitment key (ideally cold) rather than use one that is generated by the wallet as normal, or signal that signing will be carried out in an interactive manner (PSBT based).  
### gRPC Response: [lnrpc.OpenStatusUpdate (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1880)


Parameter | Type | Description
--------- | ---- | ----------- 
chan_pending | [PendingUpdate](#lnrpc-pendingupdate) | Signals that the channel is now fully negotiated and the funding transaction published. 
chan_open | [ChannelOpenUpdate](#lnrpc-channelopenupdate) | Signals that the channel's funding transaction has now reached the required number of confirmations on chain and can be used. 
psbt_fund | [ReadyForPsbtFunding](#lnrpc-readyforpsbtfunding) | Signals that the funding process has been suspended and the construction of a PSBT that funds the channel PK script is now required. 
...
close_address | string | Close address is an optional address which specifies the address to which funds should be paid out to upon cooperative close. This field may only be set if the peer supports the option upfront feature bit (call listpeers to check). The remote peer will only accept cooperative closes to this address if it is set.  Note: If this value is set on channel creation, you will *not* be able to cooperatively close out to a different address. 
funding_shim | [FundingShim](#lnrpc-fundingshim) | Funding shims are an optional argument that allow the caller to intercept certain funding functionality. For example, a shim can be provided to use a particular key for the commitment key (ideally cold) rather than use one that is generated by the wallet as normal, or signal that signing will be carried out in an interactive manner (PSBT based).  
### gRPC Response: [lnrpc.ChannelPoint ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1110)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.PendingChannelsRequest()
...
### gRPC Request: [lnrpc.PendingChannelsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2077)


This request has no parameters.

### gRPC Response: [lnrpc.PendingChannelsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2079)


Parameter | Type | Description
--------- | ---- | ----------- 
total_limbo_balance | int64 | The balance in satoshis encumbered in pending channels 
pending_open_channels | [array PendingOpenChannel](#lnrpc-pendingchannelsresponse-pendingopenchannel) | Channels pending opening 
pending_closing_channels | [array ClosedChannel](#lnrpc-pendingchannelsresponse-closedchannel) | Deprecated: Channels pending closing previously contained cooperatively closed channels with a single confirmation. These channels are now considered closed from the time we see them on chain. 
pending_force_closing_channels | [array ForceClosedChannel](#lnrpc-pendingchannelsresponse-forceclosedchannel) | Channels pending force closing 
waiting_close_channels | [array WaitingCloseChannel](#lnrpc-pendingchannelsresponse-waitingclosechannel) | Channels waiting for closing tx to confirm  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.QueryRoutesRequest(
        pub_key=<string>,
        amt=<int64>,
        amt_msat=<int64>,
...
### gRPC Request: [lnrpc.QueryRoutesRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2284)
...
ignored_edges | [array EdgeLocator](#lnrpc-edgelocator) | Deprecated. A list of edges to ignore during path finding. 
...
ignored_pairs | [array NodePair](#lnrpc-nodepair) | A list of directed node pairs that will be ignored during path finding. 
...
dest_custom_records | [array DestCustomRecordsEntry](#lnrpc-queryroutesrequest-destcustomrecordsentry) | An optional field that can be used to pass an arbitrary set of TLV records to a peer which understands the new records. This can be used to pass application specific data during the payment attempt. If the destination does not support the specified recrods, and error will be returned. Record types are required to be in the custom range >= 65536. When using REST, the values must be encoded as base64. 
...
route_hints | [array RouteHint](#lnrpc-routehint) | Optional route hints to reach the destination through private channels. 
dest_features | [array FeatureBit](#lnrpc-featurebit) | Features assumed to be supported by the final node. All transitive feature dependencies must also be set properly. For a given feature bit pair, either optional or remote may be set, but not both. If this field is nil or empty, the router will try to load destination features from the graph as a fallback.  
### gRPC Response: [lnrpc.QueryRoutesResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2419)


Parameter | Type | Description
--------- | ---- | ----------- 
routes | [array Route](#lnrpc-route) | The route that results from the path finding operation. This is still a repeated field to retain backwards compatibility. 
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.RestoreChanBackupRequest(
...
### gRPC Request: [lnrpc.RestoreChanBackupRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3487)


Parameter | Type | Description
--------- | ---- | ----------- 
chan_backups | [ChannelBackups](#lnrpc-channelbackups) | The channels to restore as a list of channel/backup pairs. 
...
### gRPC Response: [lnrpc.RestoreBackupResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3501)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.SendCoinsRequest(
        addr=<string>,
        amount=<int64>,
        target_conf=<int32>,
        sat_per_byte=<int64>,
...
### gRPC Request: [lnrpc.SendCoinsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1183)
...
### gRPC Response: [lnrpc.SendCoinsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1205)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.SendManyRequest(
        AddrToAmount=<array AddrToAmountEntry>,
        target_conf=<int32>,
        sat_per_byte=<int64>,
    )
...
### gRPC Request: [lnrpc.SendManyRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1166)


Parameter | Type | Description
--------- | ---- | ----------- 
AddrToAmount | [array AddrToAmountEntry](#lnrpc-sendmanyrequest-addrtoamountentry) | The map from addresses to amounts 
target_conf | int32 | The target number of blocks that this transaction should be confirmed / by. 
sat_per_byte | int64 | A manual fee rate set in sat/byte that should be used when crafting the / transaction.  
### gRPC Response: [lnrpc.SendManyResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1178)
...
# --show_inflight                 if set, intermediate payment state updates will be displayed
# --max_shards value              the maximum number of partial payments that may be used (default: 1)
...
### gRPC Request: [lnrpc.SendRequest (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L927)
...
dest_custom_records | [array DestCustomRecordsEntry](#lnrpc-sendrequest-destcustomrecordsentry) | An optional field that can be used to pass an arbitrary set of TLV records to a peer which understands the new records. This can be used to pass application specific data during the payment attempt. Record types are required to be in the custom range >= 65536. When using REST, the values must be encoded as base64. 
allow_self_payment | bool | If set, circular payments to self are permitted. 
dest_features | [array FeatureBit](#lnrpc-featurebit) | Features assumed to be supported by the final node. All transitive feature dependencies must also be set properly. For a given feature bit pair, either optional or remote may be set, but not both. If this field is nil or empty, the router will try to load destination features from the graph as a fallback.  
### gRPC Response: [lnrpc.SendResponse (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1027)
...
### gRPC Request: [lnrpc.SendRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L927)
...
allow_self_payment | bool | If set, circular payments to self are permitted. 
dest_features | [array FeatureBit](#lnrpc-featurebit) | Features assumed to be supported by the final node. All transitive feature dependencies must also be set properly. For a given feature bit pair, either optional or remote may be set, but not both. If this field is nil or empty, the router will try to load destination features from the graph as a fallback.  
### gRPC Response: [lnrpc.SendResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1027)
...
>>> def request_generator():
        ...
        while True:
            # Parameters here can be set as arguments to the generator.
            request = lnd.lnrpc.SendToRouteRequest(
                payment_hash=<bytes>,
                payment_hash_string=<string>,
                route=<Route>,
            )
...
### gRPC Request: [lnrpc.SendToRouteRequest (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1034)
...
### gRPC Request: [lnrpc.SendToRouteRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1034)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.SignMessageRequest(
        msg=<bytes>,
    )
...
### gRPC Request: [lnrpc.SignMessageRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1244)


Parameter | Type | Description
--------- | ---- | ----------- 
msg | bytes | The message to be signed. When using REST, this field must be encoded as base64.  
### gRPC Response: [lnrpc.SignMessageResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1251)
...
### gRPC Request: [lnrpc.StopRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2706)


This request has no parameters.

### gRPC Response: [lnrpc.StopResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2708)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ChannelBackupSubscription()
...
### gRPC Request: [lnrpc.ChannelBackupSubscription ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3504)


This request has no parameters.

### gRPC Response: [lnrpc.ChanBackupSnapshot (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3466)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ChannelEventSubscription()
...
### gRPC Request: [lnrpc.ChannelEventSubscription ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2238)


This request has no parameters.

### gRPC Response: [lnrpc.ChannelEventUpdate (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2241)
...
pending_open_channel | [PendingUpdate](#lnrpc-pendingupdate) |  
type | [UpdateType](#lnrpc-channeleventupdate-updatetype) |   
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.GraphTopologySubscription()
...
### gRPC Request: [lnrpc.GraphTopologySubscription ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2711)


This request has no parameters.

### gRPC Response: [lnrpc.GraphTopologyUpdate (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2713)


Parameter | Type | Description
--------- | ---- | ----------- 
node_updates | [array NodeUpdate](#lnrpc-nodeupdate) |  
channel_updates | [array ChannelEdgeUpdate](#lnrpc-channeledgeupdate) |  
closed_chans | [array ClosedChannelUpdate](#lnrpc-closedchannelupdate) |   
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.InvoiceSubscription(
        add_index=<uint64>,
        settle_index=<uint64>,
    )
...
### gRPC Request: [lnrpc.InvoiceSubscription ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3041)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.PeerEventSubscription()
...
### gRPC Request: [lnrpc.PeerEventSubscription ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1642)


This request has no parameters.

### gRPC Response: [lnrpc.PeerEvent (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1645)


Parameter | Type | Description
--------- | ---- | ----------- 
pub_key | string | The identity pubkey of the peer. 
type | [EventType](#lnrpc-peerevent-eventtype) |   
...
### gRPC Response: [lnrpc.Transaction (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L871)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.PolicyUpdateRequest(
        global=<bool>,
        chan_point=<ChannelPoint>,
        base_fee_msat=<int64>,
        fee_rate=<double>,
...
### gRPC Request: [lnrpc.PolicyUpdateRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3329)
...
### gRPC Response: [lnrpc.PolicyUpdateResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3359)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.ChanBackupSnapshot(
        single_chan_backups=<ChannelBackups>,
        multi_chan_backup=<MultiChanBackup>,
    )
...
### gRPC Request: [lnrpc.ChanBackupSnapshot ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3466)
...
single_chan_backups | [ChannelBackups](#lnrpc-channelbackups) | The set of new channels that have been added since the last channel backup snapshot was requested. 
multi_chan_backup | [MultiChanBackup](#lnrpc-multichanbackup) | A multi-channel backup that covers all open channels currently known to lnd.  
### gRPC Response: [lnrpc.VerifyChanBackupResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3507)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.VerifyMessageRequest(
        msg=<bytes>,
        signature=<string>,
    )
...
### gRPC Request: [lnrpc.VerifyMessageRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1256)
...
### gRPC Response: [lnrpc.VerifyMessageResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L1266)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.LightningStub(channel)
>>> request = lnd.lnrpc.WalletBalanceRequest()
...
### gRPC Request: [lnrpc.WalletBalanceRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2261)


This request has no parameters.

### gRPC Response: [lnrpc.WalletBalanceResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L2263)
...
```python
>>> import codecs, grpc, os
>>> import rpc_pb2 as lnd, rpc_pb2_grpc as routerrpc
>>> macaroon = codecs.encode(open('LND_DIR/data/chain/bitcoin/simnet/admin.macaroon', 'rb').read(), 'hex')
>>> os.environ['GRPC_SSL_CIPHER_SUITES'] = 'HIGH+ECDSA'
>>> cert = open('LND_DIR/tls.cert', 'rb').read()
>>> ssl_creds = grpc.ssl_channel_credentials(cert)
...
>>> request = lnd.routerrpc.BuildRouteRequest(
        amt_msat=<int64>,
        final_cltv_delta=<int32>,
        outgoing_chan_id=<uint64>,
...
const grpc = require('grpc');
const macaroon = fs.readFileSync("LND_DIR/data/chain/bitcoin/simnet/admin.macaroon").toString('hex');
const routerrpc = grpc.load('routerrpc/router.proto').routerrpc;
process.env.GRPC_SSL_CIPHER_SUITES = 'HIGH+ECDSA';
const lndCert = fs.readFileSync('LND_DIR/tls.cert');
const sslCreds = grpc.credentials.createSsl(lndCert);
const macaroonCreds = grpc.credentials.createFromMetadataGenerator(function(args, callback) {
...
### gRPC Request: [routerrpc.BuildRouteRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L250)
...
### gRPC Response: [routerrpc.BuildRouteResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L276)


Parameter | Type | Description
--------- | ---- | ----------- 
route | [Route](#lnrpc-route) | Fully specified route that can be used to execute the payment.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.RouteFeeRequest(
        dest=<bytes>,
        amt_sat=<int64>,
    )
...
### gRPC Request: [routerrpc.RouteFeeRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L130)
...
### gRPC Response: [routerrpc.RouteFeeResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L142)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.QueryMissionControlRequest()
...
### gRPC Request: [routerrpc.QueryMissionControlRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L179)


This request has no parameters.

### gRPC Response: [routerrpc.QueryMissionControlResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L183)


Parameter | Type | Description
--------- | ---- | ----------- 
pairs | [array PairHistory](#routerrpc-pairhistory) | Node pair-level mission control state.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.QueryProbabilityRequest(
        from_node=<bytes>,
        to_node=<bytes>,
        amt_msat=<int64>,
    )
...
### gRPC Request: [routerrpc.QueryProbabilityRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L231)
...
### gRPC Response: [routerrpc.QueryProbabilityResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L242)


Parameter | Type | Description
--------- | ---- | ----------- 
probability | double | The success probability for the requested pair. 
history | [PairData](#routerrpc-pairdata) | The historical data for the requested pair.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.ResetMissionControlRequest()
...
### gRPC Request: [routerrpc.ResetMissionControlRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L173)


This request has no parameters.

### gRPC Response: [routerrpc.ResetMissionControlResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L176)
...
SendPayment attempts to route a payment described by the passed PaymentRequest to the final destination. The call returns a stream of payment updates.
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.SendPaymentRequest(
        dest=<bytes>,
        amt=<int64>,
        amt_msat=<int64>,
        payment_hash=<bytes>,
...
### gRPC Request: [routerrpc.SendPaymentRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L9)
...
route_hints | [array RouteHint](#lnrpc-routehint) | Optional route hints to reach the destination through private channels. 
dest_custom_records | [array DestCustomRecordsEntry](#routerrpc-sendpaymentrequest-destcustomrecordsentry) | An optional field that can be used to pass an arbitrary set of TLV records to a peer which understands the new records. This can be used to pass application specific data during the payment attempt. Record types are required to be in the custom range >= 65536. When using REST, the values must be encoded as base64. 
allow_self_payment | bool | If set, circular payments to self are permitted. 
dest_features | [array FeatureBit](#lnrpc-featurebit) | Features assumed to be supported by the final node. All transitive feature dependencies must also be set properly. For a given feature bit pair, either optional or remote may be set, but not both. If this field is nil or empty, the router will try to load destination features from the graph as a fallback. 
max_shards | uint32 | The maximum number of partial payments that may be use to complete the full amount.  
### gRPC Response: [lnrpc.Payment (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L3093)
...
status | [PaymentStatus](#lnrpc-payment-paymentstatus) | The status of the payment. 
...
htlcs | [array HTLCAttempt](#lnrpc-htlcattempt) | The HTLCs made in attempt to settle the payment [EXPERIMENTAL]. 
...
failure_reason | [PaymentFailureReason](#lnrpc-paymentfailurereason) |   
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.SendToRouteRequest(
        payment_hash=<bytes>,
        route=<Route>,
    )
...
### gRPC Request: [routerrpc.SendToRouteRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L157)
...
route | [Route](#lnrpc-route) | Route that should be used to attempt to complete the payment.  
### gRPC Response: [routerrpc.SendToRouteResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L165)


Parameter | Type | Description
--------- | ---- | ----------- 
preimage | bytes | The preimage obtained by making the payment. 
failure | [Failure](#lnrpc-failure) | The failure message in case the payment failed.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.SubscribeHtlcEventsRequest()
...
let router = new routerrpc.Router('localhost:10009', creds);
let request = {}; 
let call = router.subscribeHtlcEvents(request);
call.on('data', function(response) {
  // A response was received from the server.
  console.log(response);
});
...
### gRPC Request: [routerrpc.SubscribeHtlcEventsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L283)


This request has no parameters.

### gRPC Response: [routerrpc.HtlcEvent (Streaming)](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L294)
...
event_type | [EventType](#routerrpc-htlcevent-eventtype) | The event type indicates whether the htlc was part of a send, receive or forward. 
forward_event | [ForwardEvent](#routerrpc-forwardevent) |  
forward_fail_event | [ForwardFailEvent](#routerrpc-forwardfailevent) |  
settle_event | [SettleEvent](#routerrpc-settleevent) |  
link_fail_event | [LinkFailEvent](#routerrpc-linkfailevent) |   
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = routerrpc.RouterStub(channel)
>>> request = lnd.routerrpc.TrackPaymentRequest(
        payment_hash=<bytes>,
    )
...
let call = router.trackPayment(request);
call.on('data', function(response) {
  // A response was received from the server.
  console.log(response);
});
...
### gRPC Request: [routerrpc.TrackPaymentRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/routerrpc/router.proto#L125)
...
```python
>>> import codecs, grpc, os
>>> import rpc_pb2 as lnd, rpc_pb2_grpc as signrpc
>>> macaroon = codecs.encode(open('LND_DIR/data/chain/bitcoin/simnet/admin.macaroon', 'rb').read(), 'hex')
>>> os.environ['GRPC_SSL_CIPHER_SUITES'] = 'HIGH+ECDSA'
>>> cert = open('LND_DIR/tls.cert', 'rb').read()
>>> ssl_creds = grpc.ssl_channel_credentials(cert)
...
const grpc = require('grpc');
const macaroon = fs.readFileSync("LND_DIR/data/chain/bitcoin/simnet/admin.macaroon").toString('hex');
const signrpc = grpc.load('signrpc/signer.proto').signrpc;
process.env.GRPC_SSL_CIPHER_SUITES = 'HIGH+ECDSA';
const lndCert = fs.readFileSync('LND_DIR/tls.cert');
const sslCreds = grpc.credentials.createSsl(lndCert);
const macaroonCreds = grpc.credentials.createFromMetadataGenerator(function(args, callback) {
...
let creds = grpc.credentials.combineChannelCredentials(sslCreds, macaroonCreds);
let signer = new signrpc.Signer('localhost:10009', creds);
let request = { 
  raw_tx_bytes: <bytes>, 
  sign_descs: <array SignDescriptor>, 
}; 
...
### gRPC Request: [signrpc.SignReq ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L91)


Parameter | Type | Description
--------- | ---- | ----------- 
raw_tx_bytes | bytes | The raw bytes of the transaction to be signed. 
sign_descs | [array SignDescriptor](#signrpc-signdescriptor) | A set of sign descriptors, for each input to be signed.  
### gRPC Response: [signrpc.InputScriptResp ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L118)


Parameter | Type | Description
--------- | ---- | ----------- 
input_scripts | [array InputScript](#signrpc-inputscript) | The set of fully valid input scripts requested.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = signrpc.SignerStub(channel)
>>> request = lnd.signrpc.SharedKeyRequest(
...
### gRPC Request: [signrpc.SharedKeyRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L155)


Parameter | Type | Description
--------- | ---- | ----------- 
ephemeral_pubkey | bytes | The ephemeral public key to use for the DH key derivation. 
key_loc | [KeyLocator](#signrpc-keylocator) | The optional key locator of the local key that should be used. If this parameter is not set then the node's identity private key will be used.  
### gRPC Response: [signrpc.SharedKeyResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L166)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = signrpc.SignerStub(channel)
>>> request = lnd.signrpc.SignMessageReq(
        msg=<bytes>,
        key_loc=<KeyLocator>,
    )
>>> response = stub.SignMessage(request, metadata=[('macaroon', macaroon)])
...
### gRPC Request: [signrpc.SignMessageReq ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L123)


Parameter | Type | Description
--------- | ---- | ----------- 
msg | bytes | The message to be signed. 
key_loc | [KeyLocator](#signrpc-keylocator) | The key locator that identifies which key to use for signing.  
### gRPC Response: [signrpc.SignMessageResp ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L130)
...
raw_tx_bytes | bytes | The raw bytes of the transaction to be signed. 
sign_descs | [array SignDescriptor](#signrpc-signdescriptor) | A set of sign descriptors, for each input to be signed.  
### gRPC Response: [signrpc.SignResp ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L99)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = signrpc.SignerStub(channel)
>>> request = lnd.signrpc.VerifyMessageReq(
        msg=<bytes>,
        signature=<bytes>,
        pubkey=<bytes>,
    )
...
### gRPC Request: [signrpc.VerifyMessageReq ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L137)
...
### gRPC Response: [signrpc.VerifyMessageResp ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L150)
...
```python
>>> import codecs, grpc, os
>>> import rpc_pb2 as lnd, rpc_pb2_grpc as verrpc
>>> macaroon = codecs.encode(open('LND_DIR/data/chain/bitcoin/simnet/admin.macaroon', 'rb').read(), 'hex')
>>> os.environ['GRPC_SSL_CIPHER_SUITES'] = 'HIGH+ECDSA'
>>> cert = open('LND_DIR/tls.cert', 'rb').read()
>>> ssl_creds = grpc.ssl_channel_credentials(cert)
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = verrpc.VersionerStub(channel)
>>> request = lnd.verrpc.VersionRequest()
>>> response = stub.GetVersion(request, metadata=[('macaroon', macaroon)])
>>> print(response)
{ 
    "commit": <string>,
    "commit_hash": <string>,
...
const grpc = require('grpc');
const macaroon = fs.readFileSync("LND_DIR/data/chain/bitcoin/simnet/admin.macaroon").toString('hex');
const verrpc = grpc.load('verrpc/verrpc.proto').verrpc;
process.env.GRPC_SSL_CIPHER_SUITES = 'HIGH+ECDSA';
const lndCert = fs.readFileSync('LND_DIR/tls.cert');
const sslCreds = grpc.credentials.createSsl(lndCert);
const macaroonCreds = grpc.credentials.createFromMetadataGenerator(function(args, callback) {
...
let creds = grpc.credentials.combineChannelCredentials(sslCreds, macaroonCreds);
let versioner = new verrpc.Versioner('localhost:10009', creds);
let request = {}; 
versioner.getVersion(request, function(err, response) {
  console.log(response);
});
// Console output:
//  { 
...
### gRPC Request: [verrpc.VersionRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/verrpc/verrpc.proto#L11)


This request has no parameters.

### gRPC Response: [verrpc.Version ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/verrpc/verrpc.proto#L14)


Parameter | Type | Description
--------- | ---- | ----------- 
commit | string | A verbose description of the daemon's commit. 
commit_hash | string | The SHA1 commit hash that the daemon is compiled with. 
version | string | The semantic version. 
app_major | uint32 | The major application version. 
app_minor | uint32 | The minor application version. 
app_patch | uint32 | The application patch number. 
app_pre_release | string | The application pre-release modifier, possibly empty. 
build_tags | array string | The list of build tags that were supplied during compilation. 
go_version | string | The version of go that compiled the executable.  
...
```python
>>> import codecs, grpc, os
>>> import rpc_pb2 as lnd, rpc_pb2_grpc as walletrpc
>>> macaroon = codecs.encode(open('LND_DIR/data/chain/bitcoin/simnet/admin.macaroon', 'rb').read(), 'hex')
>>> os.environ['GRPC_SSL_CIPHER_SUITES'] = 'HIGH+ECDSA'
>>> cert = open('LND_DIR/tls.cert', 'rb').read()
>>> ssl_creds = grpc.ssl_channel_credentials(cert)
...
>>> request = lnd.walletrpc.BumpFeeRequest(
        outpoint=<OutPoint>,
        target_conf=<uint32>,
        sat_per_byte=<uint32>,
        force=<bool>,
...
const grpc = require('grpc');
const macaroon = fs.readFileSync("LND_DIR/data/chain/bitcoin/simnet/admin.macaroon").toString('hex');
const walletrpc = grpc.load('walletrpc/walletkit.proto').walletrpc;
process.env.GRPC_SSL_CIPHER_SUITES = 'HIGH+ECDSA';
const lndCert = fs.readFileSync('LND_DIR/tls.cert');
const sslCreds = grpc.credentials.createSsl(lndCert);
const macaroonCreds = grpc.credentials.createFromMetadataGenerator(function(args, callback) {
...
### gRPC Request: [walletrpc.BumpFeeRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L224)


Parameter | Type | Description
--------- | ---- | ----------- 
outpoint | [OutPoint](#lnrpc-outpoint) | The input we're attempting to bump the fee of. 
...
### gRPC Response: [walletrpc.BumpFeeResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L244)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = walletrpc.WalletKitStub(channel)
>>> request = lnd.signrpc.KeyLocator(
        key_family=<int32>,
        key_index=<int32>,
    )
...
### gRPC Request: [signrpc.KeyLocator ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L7)
...
### gRPC Response: [signrpc.KeyDescriptor ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/signrpc/signer.proto#L15)
...
### gRPC Request: [walletrpc.KeyReq ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L10)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = walletrpc.WalletKitStub(channel)
>>> request = lnd.walletrpc.EstimateFeeRequest(
        conf_target=<int32>,
    )
>>> response = stub.EstimateFee(request, metadata=[('macaroon', macaroon)])
>>> print(response)
...
### gRPC Request: [walletrpc.EstimateFeeRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L71)


Parameter | Type | Description
--------- | ---- | ----------- 
conf_target | int32 | The number of confirmations to shoot for when estimating the fee.  
### gRPC Response: [walletrpc.EstimateFeeResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L77)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = walletrpc.WalletKitStub(channel)
>>> request = lnd.walletrpc.AddrRequest()
...
### gRPC Request: [walletrpc.AddrRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L25)


This request has no parameters.

### gRPC Response: [walletrpc.AddrResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L28)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = walletrpc.WalletKitStub(channel)
>>> request = lnd.walletrpc.PendingSweepsRequest()
...
### gRPC Request: [walletrpc.PendingSweepsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L214)


This request has no parameters.

### gRPC Response: [walletrpc.PendingSweepsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L217)


Parameter | Type | Description
--------- | ---- | ----------- 
pending_sweeps | [array PendingSweep](#walletrpc-pendingsweep) | The set of outputs currently being swept by lnd's central batching engine.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = walletrpc.WalletKitStub(channel)
>>> request = lnd.walletrpc.Transaction(
        tx_hex=<bytes>,
    )
...
### gRPC Request: [walletrpc.Transaction ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L35)


Parameter | Type | Description
--------- | ---- | ----------- 
tx_hex | bytes | The raw serialized transaction.  
### gRPC Response: [walletrpc.PublishResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L41)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = walletrpc.WalletKitStub(channel)
>>> request = lnd.walletrpc.SendOutputsRequest(
        sat_per_kw=<int64>,
        outputs=<array TxOut>,
    )
...
### gRPC Request: [walletrpc.SendOutputsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L52)


Parameter | Type | Description
--------- | ---- | ----------- 
sat_per_kw | int64 | The number of satoshis per kilo weight that should be used when crafting this transaction. 
outputs | [array TxOut](#signrpc-txout) | A slice of the outputs that should be created in the transaction produced.  
### gRPC Response: [walletrpc.SendOutputsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/walletrpc/walletkit.proto#L64)
...
>>> request = lnd.lnrpc.ChangePasswordRequest(
...
### gRPC Request: [lnrpc.ChangePasswordRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L202)
...
### gRPC Response: [lnrpc.ChangePasswordResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L215)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.WalletUnlockerStub(channel)
>>> request = lnd.lnrpc.GenSeedRequest(
...
### gRPC Request: [lnrpc.GenSeedRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L95)
...
### gRPC Response: [lnrpc.GenSeedResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L110)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.WalletUnlockerStub(channel)
>>> request = lnd.lnrpc.InitWalletRequest(
...
### gRPC Request: [lnrpc.InitWalletRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L127)
...
### gRPC Response: [lnrpc.InitWalletResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L169)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = lnrpc.WalletUnlockerStub(channel)
>>> request = lnd.lnrpc.UnlockWalletRequest(
        wallet_password=<bytes>,
        recovery_window=<int32>,
        channel_backups=<ChanBackupSnapshot>,
    )
...
### gRPC Request: [lnrpc.UnlockWalletRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L172)
...
recovery_window | int32 | recovery_window is an optional argument specifying the address lookahead when restoring a wallet seed. The recovery window applies to each individual branch of the BIP44 derivation paths. Supplying a recovery window of zero indicates that no addresses should be recovered, such after the first initialization of the wallet. 
channel_backups | [ChanBackupSnapshot](#lnrpc-chanbackupsnapshot) | channel_backups is an optional argument that allows clients to recover the settled funds within a set of channels. This should be populated if the user was unable to close out all channels and sweep funds before partial or total data loss occurred. If specified, then after on-chain recovery of funds, lnd begin to carry out the data loss recovery protocol in order to recover the funds in each channel from a remote force closed transaction.  
### gRPC Response: [lnrpc.UnlockWalletResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.proto#L199)
...
```python
>>> import codecs, grpc, os
>>> import rpc_pb2 as lnd, rpc_pb2_grpc as watchtowerrpc
>>> macaroon = codecs.encode(open('LND_DIR/data/chain/bitcoin/simnet/admin.macaroon', 'rb').read(), 'hex')
>>> os.environ['GRPC_SSL_CIPHER_SUITES'] = 'HIGH+ECDSA'
>>> cert = open('LND_DIR/tls.cert', 'rb').read()
>>> ssl_creds = grpc.ssl_channel_credentials(cert)
...
>>> request = lnd.watchtowerrpc.GetInfoRequest()
>>> response = stub.GetInfo(request, metadata=[('macaroon', macaroon)])
>>> print(response)
{ 
    "pubkey": <bytes>,
...
const grpc = require('grpc');
const macaroon = fs.readFileSync("LND_DIR/data/chain/bitcoin/simnet/admin.macaroon").toString('hex');
const watchtowerrpc = grpc.load('watchtowerrpc/watchtower.proto').watchtowerrpc;
process.env.GRPC_SSL_CIPHER_SUITES = 'HIGH+ECDSA';
const lndCert = fs.readFileSync('LND_DIR/tls.cert');
const sslCreds = grpc.credentials.createSsl(lndCert);
const macaroonCreds = grpc.credentials.createFromMetadataGenerator(function(args, callback) {
...
let creds = grpc.credentials.combineChannelCredentials(sslCreds, macaroonCreds);
let watchtower = new watchtowerrpc.Watchtower('localhost:10009', creds);
let request = {}; 
...
### gRPC Request: [watchtowerrpc.GetInfoRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/watchtowerrpc/watchtower.proto#L16)


This request has no parameters.

### gRPC Response: [watchtowerrpc.GetInfoResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/watchtowerrpc/watchtower.proto#L19)
...
```python
>>> import codecs, grpc, os
>>> import rpc_pb2 as lnd, rpc_pb2_grpc as wtclientrpc
>>> macaroon = codecs.encode(open('LND_DIR/data/chain/bitcoin/simnet/admin.macaroon', 'rb').read(), 'hex')
>>> os.environ['GRPC_SSL_CIPHER_SUITES'] = 'HIGH+ECDSA'
>>> cert = open('LND_DIR/tls.cert', 'rb').read()
>>> ssl_creds = grpc.ssl_channel_credentials(cert)
...
>>> request = lnd.wtclientrpc.AddTowerRequest(
        pubkey=<bytes>,
        address=<string>,
    )
...
const grpc = require('grpc');
const macaroon = fs.readFileSync("LND_DIR/data/chain/bitcoin/simnet/admin.macaroon").toString('hex');
const wtclientrpc = grpc.load('wtclientrpc/wtclient.proto').wtclientrpc;
process.env.GRPC_SSL_CIPHER_SUITES = 'HIGH+ECDSA';
const lndCert = fs.readFileSync('LND_DIR/tls.cert');
const sslCreds = grpc.credentials.createSsl(lndCert);
const macaroonCreds = grpc.credentials.createFromMetadataGenerator(function(args, callback) {
...
let creds = grpc.credentials.combineChannelCredentials(sslCreds, macaroonCreds);
let watchtowerClient = new wtclientrpc.WatchtowerClient('localhost:10009', creds);
let request = { 
  pubkey: <bytes>, 
  address: <string>, 
}; 
...
### gRPC Request: [wtclientrpc.AddTowerRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L7)
...
### gRPC Response: [wtclientrpc.AddTowerResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L15)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = wtclientrpc.WatchtowerClientStub(channel)
>>> request = lnd.wtclientrpc.GetTowerInfoRequest(
        pubkey=<bytes>,
...
### gRPC Request: [wtclientrpc.GetTowerInfoRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L33)
...
### gRPC Response: [wtclientrpc.Tower ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L64)
...
sessions | [array TowerSession](#wtclientrpc-towersession) | The list of sessions that have been negotiated with the watchtower.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = wtclientrpc.WatchtowerClientStub(channel)
>>> request = lnd.wtclientrpc.ListTowersRequest(
        include_sessions=<bool>,
    )
...
### gRPC Request: [wtclientrpc.ListTowersRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L81)


Parameter | Type | Description
--------- | ---- | ----------- 
include_sessions | bool | Whether we should include sessions with the watchtower in the response.  
### gRPC Response: [wtclientrpc.ListTowersResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L86)


Parameter | Type | Description
--------- | ---- | ----------- 
towers | [array Tower](#wtclientrpc-tower) | The list of watchtowers available for new backups.  
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = wtclientrpc.WatchtowerClientStub(channel)
>>> request = lnd.wtclientrpc.PolicyRequest()
...
### gRPC Request: [wtclientrpc.PolicyRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L120)


This request has no parameters.

### gRPC Response: [wtclientrpc.PolicyResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L123)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = wtclientrpc.WatchtowerClientStub(channel)
>>> request = lnd.wtclientrpc.RemoveTowerRequest(
        pubkey=<bytes>,
        address=<string>,
    )
...
### gRPC Request: [wtclientrpc.RemoveTowerRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L18)
...
### gRPC Response: [wtclientrpc.RemoveTowerResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L30)
...
>>> channel = grpc.secure_channel('localhost:10009', ssl_creds)
>>> stub = wtclientrpc.WatchtowerClientStub(channel)
>>> request = lnd.wtclientrpc.StatsRequest()
...
### gRPC Request: [wtclientrpc.StatsRequest ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L91)


This request has no parameters.

### gRPC Response: [wtclientrpc.StatsResponse ](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/wtclientrpc/wtclient.proto#L94)
...
Parameter | Type | Description
--------- | ---- | ----------- 
outpoint | [OutPoint](#lnrpc-outpoint) | The outpoint of the output we're attempting to sweep. 
...
Parameter | Type | Description
--------- | ---- | ----------- 
info | [HtlcInfo](#routerrpc-htlcinfo) | Info contains details about the htlc that was forwarded.  
...
Parameter | Type | Description
--------- | ---- | ----------- 
info | [HtlcInfo](#routerrpc-htlcinfo) | Info contains details about the htlc that we failed. 
wire_failure | [FailureCode](#lnrpc-failure-failurecode) | FailureCode is the BOLT error code for the failure. 
failure_detail | [FailureDetail](#routerrpc-failuredetail) | FailureDetail provides additional information about the reason for the failure. This detail enriches the information provided by the wire message and may be 'no detail' if the wire message requires no additional metadata. 
...
history | [PairData](#routerrpc-pairdata) |   
...
chan_point | [ChannelPoint](#lnrpc-channelpoint) | The target channel point to refrence in created commitment transactions. 
local_key | [KeyDescriptor](#lnrpc-keydescriptor) | Our local key to use when creating the multi-sig output. 
...
pending_htlcs | [array HTLC](#lnrpc-htlc) | The list of active, uncleared HTLCs currently pending within the channel. 
...
commitment_type | [CommitmentType](#lnrpc-commitmenttype) | The commitment type used by this channel. 
...
Parameter | Type | Description
--------- | ---- | ----------- 
chan_backups | [array ChannelBackup](#lnrpc-channelbackup) | A set of single-chan static channel backups.  
...
close_type | [ClosureType](#lnrpc-channelclosesummary-closuretype) | Details on how the channel was closed. 
open_initiator | [Initiator](#lnrpc-initiator) | Open initiator is the party that initiated opening the channel. Note that this value may be unknown if the channel was closed before we migrated to store open channel information after close. 
close_initiator | [Initiator](#lnrpc-initiator) | Close initiator indicates which party initiated the close. This value will be unknown for channels that were cooperatively closed before we started tracking cooperative close initiators. Note that this indicates which party initiated a close, and it is possible for both to initiate cooperative or force closes, although only one party's close will be confirmed on chain.  
...
Parameter | Type | Description
--------- | ---- | ----------- 
code | [FailureCode](#lnrpc-failure-failurecode) | Failure code as defined in the Lightning spec 
channel_update | [ChannelUpdate](#lnrpc-channelupdate) | An optional channel update message. 
...
Parameter | Type | Description
--------- | ---- | ----------- 
chan_point_shim | [ChanPointShim](#lnrpc-chanpointshim) | A channel shim where the channel point was fully constructed outside of lnd's wallet and the transaction might already be published. 
psbt_shim | [PsbtShim](#lnrpc-psbtshim) | A channel shim that uses a PSBT to fund and sign the channel funding transaction.  
...
Parameter | Type | Description
--------- | ---- | ----------- 
status | [HTLCStatus](#lnrpc-htlcattempt-htlcstatus) | The status of the HTLC. 
route | [Route](#lnrpc-route) | The route taken by this HTLC. 
...
failure | [Failure](#lnrpc-failure) | Detailed htlc failure info.  
...
mpp_record | [MPPRecord](#lnrpc-mpprecord) | An optional TLV record tha singals the use of an MPP payment. If present, the receiver will enforce that that the same mpp_record is included in the final hop payload of all non-zero payments in the HTLC set. If empty, a regular single-shot payment is or was attempted. 
custom_records | [array CustomRecordsEntry](#lnrpc-hop-customrecordsentry) | An optional set of key-value TLV records. This is useful within the context of the SendToRoute call as it allows callers to specify arbitrary K-V pairs to drop off at each hop within the onion.  
...
custom_records | [array CustomRecordsEntry](#lnrpc-invoicehtlc-customrecordsentry) | Custom tlv records. 
...
key_loc | [KeyLocator](#lnrpc-keylocator) | The key locator that identifies which key to use for signing.  
...
pub_key | string |  
alias | string |  
addresses | [array NodeAddress](#lnrpc-nodeaddress) |  
color | string |  
features | [array FeaturesEntry](#lnrpc-lightningnode-featuresentry) |   
...
Parameter | Type | Description
--------- | ---- | ----------- 
chan_points | [array ChannelPoint](#lnrpc-channelpoint) | Is the set of all channels that are included in this multi-channel backup. 
...
--------- | ---- | ----------- 
key | string |  
value | [FloatMetric](#lnrpc-floatmetric) |   
...
sync_type | [SyncType](#lnrpc-peer-synctype) | The type of sync we are currently performing with this peer. 
features | [array FeaturesEntry](#lnrpc-peer-featuresentry) | Features advertised by the remote peer in their init message. 
errors | [array TimestampedError](#lnrpc-timestampederror) | The latest errors received from our peer with timestamps, limited to the 10 most recent errors. These errors are tracked across peer connections, but are not persisted across lnd restarts. Note that these errors are only stored for peers that we have channels open with, to prevent peers from spamming us with errors at no cost.  
...
Parameter | Type | Description
--------- | ---- | ----------- 
channel | [PendingChannel](#lnrpc-pendingchannelsresponse-pendingchannel) | The pending channel to be closed 
...
Parameter | Type | Description
--------- | ---- | ----------- 
channel | [PendingChannel](#lnrpc-pendingchannelsresponse-pendingchannel) | The pending channel to be force closed 
closing_txid | string | The transaction id of the closing transaction 
...
pending_htlcs | [array PendingHTLC](#lnrpc-pendinghtlc) |  
anchor | [AnchorState](#lnrpc-pendingchannelsresponse-forceclosedchannel-anchorstate) |   
...
local_chan_reserve_sat | int64 | The minimum satoshis this node is required to reserve in its / balance. 
remote_chan_reserve_sat | int64 | The minimum satoshis the other node is required to reserve in its balance. 
initiator | [Initiator](#lnrpc-initiator) | The party that initiated opening the channel. 
commitment_type | [CommitmentType](#lnrpc-commitmenttype) | The commitment type used by this channel.  
...
Parameter | Type | Description
--------- | ---- | ----------- 
channel | [PendingChannel](#lnrpc-pendingchannelsresponse-pendingchannel) | The pending channel 
...
Parameter | Type | Description
--------- | ---- | ----------- 
channel | [PendingChannel](#lnrpc-pendingchannelsresponse-pendingchannel) | The pending channel waiting for closing tx to confirm 
limbo_balance | int64 | The balance in satoshis encumbered in this channel 
commitments | [Commitments](#lnrpc-pendingchannelsresponse-commitments) | A list of valid commitment transactions. Any of these can confirm at this point.  
...
hops | [array Hop](#lnrpc-hop) | Contains details concerning the specific forwarding details at each hop. 
...
Parameter | Type | Description
--------- | ---- | ----------- 
hop_hints | [array HopHint](#lnrpc-hophint) | A list of hop hints that when chained together can assist in reaching a specific destination.  
...
Parameter | Type | Description
--------- | ---- | ----------- 
address_type | [AddressType](#lnrpc-addresstype) | The type of address 
...
### lnclipb.VersionResponse


Parameter | Type | Description
--------- | ---- | ----------- 
lncli | [Version](#verrpc-version) | The version information for lncli. 
lnd | [Version](#verrpc-version) | The version information for lnd.  
...
--------- | ---- | ----------- 
heuristic | string |  
scores | [array ScoresEntry](#autopilotrpc-queryscoresresponse-heuristicresult-scoresentry) |   
...
COMMITMENT_ANCHOR | 13 | A witness type that allows us to spend our anchor on the commitment transaction.  
...
Name | Value | Description
---- | ----- | ----------- 
LEGACY | 0 | A channel using the legacy commitment format having tweaked to_remote keys. 
STATIC_REMOTE_KEY | 1 | A channel that uses the modern commitment format where the key in the output of the remote party does not change each state. This makes back up and recovery easier as when the channel is closed, the funds go directly to that key. 
ANCHORS | 2 | A channel that uses a commitment format that has anchor outputs on the commitments, allowing fee bumping after a force close transaction has been broadcast. 
UNKNOWN_COMMITMENT_TYPE | 999 | Returned when the commitment type isn't known or unavailable.  
...
- [`rpc.swagger.json`](https://github.com/lightningnetwork/lnd/blob/9c4f9416d53b523b00ee34e5cb1dcd834c33e1e0/lnrpc/rpc.swagger.json)
...
{ 
    ...
    "pending_open_channels": <array lnrpcPendingChannelsResponsePendingOpenChannel>, 
    "pending_closing_channels": <array lnrpcPendingChannelsResponseClosedChannel>, 
    "pending_force_closing_channels": <array lnrpcPendingChannelsResponseForceClosedChannel>, 
    "waiting_close_channels": <array lnrpcPendingChannelsResponseWaitingCloseChannel>, 
}
```
```python
>>> import base64, codecs, json, requests
...
pending_open_channels | [array lnrpcPendingChannelsResponsePendingOpenChannel](#lnrpcpendingchannelsresponsependingopenchannel) | Channels pending opening 
pending_closing_channels | [array lnrpcPendingChannelsResponseClosedChannel](#lnrpcpendingchannelsresponseclosedchannel) | Deprecated: Channels pending closing previously contained cooperatively closed channels with a single confirmation. These channels are now considered closed from the time we see them on chain. 
pending_force_closing_channels | [array lnrpcPendingChannelsResponseForceClosedChannel](#lnrpcpendingchannelsresponseforceclosedchannel) | Channels pending force closing 
waiting_close_channels | [array lnrpcPendingChannelsResponseWaitingCloseChannel](#lnrpcpendingchannelsresponsewaitingclosechannel) | Channels waiting for closing tx to confirm  
...
failure_reason | [lnrpcPaymentFailureReason](#lnrpcpaymentfailurereason) | 
...
### lnrpcPendingChannelsResponseClosedChannel

Field | Type | Description
----- | ---- | ----------- 
channel | [lnrpcPendingChannelsResponsePendingChannel](#lnrpcpendingchannelsresponsependingchannel) | The pending channel to be closed
closing_txid | string | The transaction id of the closing transaction


### lnrpcPendingChannelsResponseCommitments
...
### lnrpcPendingChannelsResponseForceClosedChannel

Field | Type | Description
----- | ---- | ----------- 
channel | [lnrpcPendingChannelsResponsePendingChannel](#lnrpcpendingchannelsresponsependingchannel) | The pending channel to be force closed
closing_txid | string | The transaction id of the closing transaction
...
### lnrpcPendingChannelsResponsePendingChannel
...
### lnrpcPendingChannelsResponsePendingOpenChannel

Field | Type | Description
----- | ---- | ----------- 
channel | [lnrpcPendingChannelsResponsePendingChannel](#lnrpcpendingchannelsresponsependingchannel) | The pending channel
...
### lnrpcPendingChannelsResponseWaitingCloseChannel

Field | Type | Description
----- | ---- | ----------- 
channel | [lnrpcPendingChannelsResponsePendingChannel](#lnrpcpendingchannelsresponsependingchannel) | The pending channel waiting for closing tx to confirm
limbo_balance | string | The balance in satoshis encumbered in this channel
commitments | [lnrpcPendingChannelsResponseCommitments](#lnrpcpendingchannelsresponsecommitments) |  A list of valid commitment transactions. Any of these can confirm at this point.
...
EXPIRY_TOO_FAR | 22 |  
MPP_TIMEOUT | 23 |  
INTERNAL_FAILURE | 24 | An internal error occurred.  
UNKNOWN_FAILURE | 25 | The error source is known, but the failure itself couldn't be decoded.  
UNREADABLE_FAILURE | 26 | An unreadable failure result is returned if the received failure message cannot be decrypted. In that case the error source is unknown.  
...
STATIC_REMOTE_KEY | 1 | A channel that uses the modern commitment format where the key in the output of the remote party does not change each state. This makes back up and recovery easier as when the channel is closed, the funds go directly to that key.  
ANCHORS | 2 | A channel that uses a commitment format that has anchor outputs on the commitments, allowing fee bumping after a force close transaction has been broadcast.  
UNKNOWN_COMMITMENT_TYPE | 3 | Returned when the commitment type isn't known or unavailable.  
...
- [Lightning Loop API Reference](loop.html)
