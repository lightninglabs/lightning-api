...
>>> import rpc_pb2 as {{component}}, rpc_pb2_grpc as {{ method.packageName }}{% if method.service != 'WalletUnlocker' %}
...
>>> stub = {{ method.packageName }}.{{ method.service }}Stub(channel){% if method.streamingRequest %}
