...
> var {{ method.packageName }} = grpc.load('{{ method.fileName }}').{{ method.packageName }};
...
> var {{ method.serviceJS }} = new {{ method.packageName }}.{{ method.service }}('localhost:10009', creds);{% endif %}
